...
- The JSON must include:
  ...
  - "interactive_buttons": array of button objects for UI (optional)
Example:
...
- Maps_TO_APPOINTMENT_BOOKING (Sehat Sahara format)
- CONTINUE_FOLLOWUP
- SHOW_PRESCRIPTION_SUMMARY
...
Enhanced Features:
- Interactive Buttons: Include interactive_buttons array for contextual UI buttons
...
{{
  "primary_intent": "one of: appointment_booking, appointment_view, appointment_cancel, health_record_request, symptom_triage, find_medicine, prescription_inquiry, medicine_scan, emergency_assistance, report_issue, post_appointment_followup, prescription_summary_request, general_inquiry, out_of_scope",
...
"""
    ...
    def _fallback_action_response(self, language: str, intent_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        mapping = {
            ...
            "post_appointment_followup": ("CONTINUE_FOLLOWUP", {}),
            "prescription_summary_request": ("SHOW_PRESCRIPTION_SUMMARY", {}),
