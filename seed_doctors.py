...
def seed_data():
    ...
    with app.app_context():
        ...
        doctors_to_add = [
            ...
            {
                "doctor_id": "DOC004",
                "full_name": "Sameer Patel",
                "specialization": "General Physician",
                "email": "sameer.patel@clinic.com",
                "password": "password123",
                "profile_image": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=2070&auto=format&fit=crop"
            }
        ]
